                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 mb-3">
                        <div class="banner_img">
                            <img class="img-fluid homebanner-thumb video_thumb sal-animate" id="bannerImage" src="https://picsum.photos/800/500"
                ...
                <div class="row">
                    <div class="col-lg-7 mb-3">
                        <div class="banner_text">
                            ...
                            <span class="sal-animate text-justify animation_text" id="type" style="font-size: 14px;text-align: justify;">
                                Membership services provide a range of benefits and exclusive access to members. These services can include
                                discounts on
                                products or services, access to events, personalized support, and more. By becoming a member, individuals can enjoy
                                a
                                range of benefits that are not available to non-mem- bers. Membership services can be an excellent way to enhance
                                customer loy- alty, build a community, and generate recurring revenue for businesses. Whether you are a business
                                owner
                                or a customer, membership services can offer an exceptional value proposition.
                            </span>
                            <p></p>
