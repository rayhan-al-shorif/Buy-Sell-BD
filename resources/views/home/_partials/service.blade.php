            ...
            <div class="col-12">
                ...
                <div class="tab-content mt-2" id="myTabContent">
                    <div class="tab-pane fade show active" id="Membership" role="tabpanel" aria-labelledby="Membership-tab">
                        <div class="row">
                            <div class="owl-carousel owl-theme owl-loaded service_slider_membership">
                    ...
                    <div class="tab-pane fade" id="ticket" role="tabpanel" aria-labelledby="Ticket-tab">
                        <div class="row">
                            <div class="owl-carousel owl-theme owl-loaded service_slider_ticket">
                                <div class="owl-stage-outer">
                                    <div class="owl-stage">
                                        <div class="owl-item">
                                            <div class="pb-6 course-padding-area sal-animate" data-sal="slide-right" data-sal-duration="800"
...
<script>
    $(document).ready(function(){
        ...
        $(".service_slider_ticket").owlCarousel({
            loop:true,
            margin:10,
