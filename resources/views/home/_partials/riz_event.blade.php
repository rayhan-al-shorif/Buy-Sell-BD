                ...
                <div class="iso_text">
                    <div class="section_heading3">
                        ...
                        <div class="read_more_btn text-left">
                            <span class="sal-animate">Read More</span>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="sal-animate readMoreAboutCeo d-none" data-sal="slide-down" data-sal-delay="300"
            data-sal-duration="1000" data-sal-easing="ease">
            <div class="iso_text">
                <div class="section_heading3">
                    <p class="text-justify">
                        ...
                        <div class="w-75 justify">
                            ...
                            <li>Club, Little Sai Wan Hong Kong, Hong Kong Cricket Club and Independent Super League team and Hong Kong XI.</li>
                                Keenly interested in sports, especially in cricket. Played cricket for Bangladesh and Hong Kong National Team. Fond of
                ...
                <div class="read_less_btn d-none text-left">
                    <span class="sal-animate">Read Less</span>
                </div>
            </div>
        </div>
    </div>
